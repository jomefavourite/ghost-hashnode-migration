...
export default function Home() {
  return (
    <main className=' min-h-screen py-5 px-5 md:px-20'>
      ...
      <div className='max-w-lg mx-auto mt-16'>
        ...
        <ul>
          ...
          <li>- Tags from Ghost don't get added to your Hashnode blog draft</li>
        </ul>
      </div>

      <p className='absolute bottom-3 text-center mx-auto w-full left-0 p-5 text-sm'>
        Built by{' '}
